...
class Profile extends BASE_Controller_Staff {
	private $id;
	...
	public function __construct(){
		...
		$this->load->model('staff/profile_model','m');
	...
	public function index()
	{
		...
		$this->load->view('staff/profile/index',$this->data);
	}
	...
	public function update()
	{
		...
		if ($this->input->server('REQUEST_METHOD') == 'POST'){
			...
			$this->form_validation->set_rules('email',"Email",'valid_email|is_unique[staffs.email]');
