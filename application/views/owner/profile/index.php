				...
				<div class="box-body">
					...
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							<li class="active"><a href="#tab_2" data-toggle="tab"><?=lang('account')?></a></li>
						...
						<div class="tab-content">
							...
							<div class="tab-pane active" id="tab_2">
								<!-- /.box-header -->
								<?=form_open_multipart('owner/profile/update',['class'=>'form-horizontal','novalidate'=>'novalidate']) ?>
							...
							<!-- /.box-header -->
								<?=form_open('staff/profile/password',['class'=>'form-horizontal','novalidate'=>'novalidate']) ?>
