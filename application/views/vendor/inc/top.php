                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="<?= base_url('upload/vendors/' . $this->session->userdata('picture') . '') ?>"
                                 class="user-image" alt="Vendor Image">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="<?= base_url('upload/vendors/' . $this->session->userdata('picture') . '') ?>"
                                     class="img-circle" alt="Vendor Image">
                                <p>
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="<?= base_url('vendor/dashboard/logout') ?>"
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="<?= (($this->uri->segment('2') == 'payments')) ? 'active' : '' ?>">
                    <a href="<?= base_url('vendor/payments') ?>">
                ...
                <li class="<?= (($this->uri->segment('2') == 'invoices')) ? 'active' : '' ?>">
                    <a href="<?= base_url('vendor/invoices') ?>">
